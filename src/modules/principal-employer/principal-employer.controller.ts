...
export class PrincipalEmployerController {
  constructor(private readonly principalEmployerService: PrincipalEmployerService) {}
  ...
  @Get()
  findAll() {
    return this.principalEmployerService.findAll();
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePrincipalEmployerDto: UpdatePrincipalEmployerDto) {
    return this.principalEmployerService.update(+id, updatePrincipalEmployerDto);
  }
